...
const ProductCard = ({
  ...
  <div className='border-b border-[#00000033] pb-6 mb-6 last:border-b-0 last:pb-0 last:mb-0'>
    <div className='flex items-start mb-4'>
      ...
      />
      <div>
        <p className='text-[23px] font-proxima-nova font-[600] leading-[28px] sm:text-xl  text-black'>
          {title}
        </p>
      </div>
    </div>
...
const innovationData = [
  ...
  },
  {
    ...
    selectedIcon: 'images/icons/whisper, api.svg',
    products: [
      {
        icon: '/images/icons/whisper, api.svg',
  ...
  },
  {
    ...
    selectedIcon: 'images/icons/grows.svg',
    products: [
      {
        icon: '/images/icons/whisper, api.svg',
  ...
  {
    icon: '/images/icons/arrowup.svg',
    title: 'Autonomous Decisions and Actions',
    selectedIcon: 'images/icons/arrowup.svg',
    products: [
      {
        icon: '/images/icons/whisper, api.svg',
  ...
  },
  {
    ...
    selectedIcon: 'images/icons/edge.svg',
    products: [
      {
  ...
  {
    icon: '/images/icons/icons.svg',
    title: 'Articul8 Library of Specialized Models',
    selectedIcon: 'images/icons/icons.svg',
    products: [
      {
        icon: '/images/icons/scoring.svg',
        title: 'Savant (Formerly Cheetah)',
