      ...
      <div className='container mx-auto px-4 sm:px-6'>
        ...
        <div className='flex flex-col lg:flex-row  lg:items-center  gap-10 lg:gap-12'>
          ...
          <div className='w-full lg:w-1/2 order-2 lg:order-2'>
            <p className='font-proxima-nova text-[16px] sm:text-[24px] font-normal leading-[19.2px] sm:leading-[28.8px]  xl:text-[24px] xl:leading-[28px] text-black text-center sm:text-left mb-4 sm:mb-6'>
            ...
            <p className='font-proxima-nova text-[16px] sm:text-[24px] font-normal leading-[19.2px] sm:leading-[28.8px] xl:text-[24px] xl:leading-[28px]   text-black text-center sm:text-left'>
