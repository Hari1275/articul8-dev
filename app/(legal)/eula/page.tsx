...
export default function EULAPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-center mb-6">ARTICUL8, INC.</h1>
      <h2 className="text-xl font-semibold text-center mb-8">A8 ESSENTIAL PLATFORM END USER LICENSE AGREEMENT</h2>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-4">2. LICENSE GRANT AND RESTRICTIONS</h2>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p>Licensee acknowledges and agrees that Articul8 shall not be liable hereunder by reason of any failure or delay in the performance of its obligations on account of strikes, riots, fires, flood, storm, explosions, acts of God, acts of terrorism, war, governmental action, earthquakes, or any other cause which is beyond the reasonable control of Articul8.</p>
        </div>
